...
class DisasterTypeSeeder extends Seeder
{
    ...
    private const DISASTER_TYPES = [
        [
            ...
            'name_ar' => 'زلازل',
            'name_en' => 'Earthquakes',
            'instructions_before_ar' => 'جهّز حقيبة طوارئ فيها ماء، إسعافات أولية، بطارية إضاءة، ووثائق مهمة. حدّد أماكن آمنة بالمنزل (تحت طاولة متينة، بعيداً عن الزجاج). تعرّف على مخارج الطوارئ بالمبنى ونقاط التجمع بالحي.',
            ...
            'instructions_during_ar' => 'انزل أرضاً واحتمِ تحت طاولة متينة وامسك بها حتى يهدأ الاهتزاز. ابتعد عن النوافذ والمرايا والأثاث الثقيل. إذا كنت بالخارج، ابتعد عن المباني والأعمدة الكهربائية. لا تستخدم المصعد.',
        ...
        [
            ...
            'instructions_after_ar' => 'لا تعد للمناطق الساحلية إلا بعد تأكيد الجهات المختصة أن الخطر زال، فقد تتكرر الموجات لساعات. احذر من الأنقاض والمياه الملوثة، وابلّغ عن المفقودين للدفاع المدني.',
